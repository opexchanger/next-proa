  ...
  return (
    <>
      <header className={styles.header}>
        {/* container */}
        <div className={[utilStyles.container, styles.header__container].join(' ')}>
          ...
          {/* menu do mobile */}
          <nav className={`${styles.nav} ${showMenu && styles.navigationOpen}`}>
            ...
            <ul className={styles.nav__list}>
              <li className={styles.nav__item}>
                <Link href="/">
                  <a className={`${styles.nav__link} ${page === 'home' && styles.current}`}>
                    Home
                  </a>
                </Link>
              </li>
              <li className={styles.nav__item}>
                <Link href="/">
                  <a
                    className={`${styles.nav__link} ${page === 'destinos' && styles.current}`}
                  >
                    Destinos
                  </a>
                </Link>
              ...
              <li className={styles.nav__item}>
                <Link href="/">
                  <a
                    className={`${styles.nav__link} ${page === 'roteiros' && styles.current}`}
                  >
                    Roteiros
                  </a>
                </Link>
